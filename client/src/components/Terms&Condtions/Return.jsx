  ...
  return (
    <div className="container__0">
      ...
      <div className="content-container">
        <p>
        Thank you for choosing our services! We are dedicated to ensuring your satisfaction with every purchase. If, for any reason, you are not completely satisfied with your order, we provide a return policy of 30 days for most products and 7 days for select items.
        </p>
        <p>
