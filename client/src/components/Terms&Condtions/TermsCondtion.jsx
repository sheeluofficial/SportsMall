    ...
    <div className="terms-container">
      ...
      <div className="terms-content">
        ...
        <p>
          ...
          agreed to in writing by SportsMall.
        </p>
        <h2>Orders</h2>
        <p>
          All orders are subject to SportsMall's acceptance. We may refuse to
        ...
        <p>
          ...
          SportsMall. Prices displayed on the website exclude shipping
          ...
          from those in physical stores that stock SportsMall products. We
        ...
        <p>
          ...
          taxes, except for those based on SportsMall's income. If
          SportsMall is required to collect and pay taxes on Customer's
        ...
        <p>
          ...
          order without SportsMall's written consent. You may return products
        ...
        <p>
          You agree to indemnify and hold SportsMall harmless from any
          claims, costs, proceedings, losses, or demands arising from your
          breach of these Terms or anyone using your account.
        </p>
        <h2>Entire Agreement</h2>
        <p>
          These Terms constitute the entire agreement between SportsMall and
