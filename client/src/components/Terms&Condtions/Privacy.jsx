  ...
  return (
    <div className="privacy-policy-container">
      ...
      <div className="container___">
        <h1>Privacy Policy of SportsMall</h1>
        <p style={{ fontSize: "16px", fontWeight: "600" }}>
          {" "}
          Effective Date: 23-12-2021
        </p>
        <p>
          At our organization, we prioritize the privacy of our customers and
          are committed to safeguarding your personal information. Our Privacy
          Policy delineates how we collect, utilize, disclose, and secure your
          data when you engage with our website and services. We encourage you
          to carefully read this Privacy Policy. By accessing or using our
          website and services, you acknowledge that you have comprehended and
          accepted all the terms outlined in this Privacy Policy.
        </p>
        ...
        <p>
          By utilizing our website and services, you consent to the collection,
          use, and disclosure of your information as detailed in this Privacy
          Policy.
        </p>
      </div>
    </div>
