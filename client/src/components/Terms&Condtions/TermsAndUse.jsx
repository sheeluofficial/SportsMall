    ...
    <div className="privacy-policy-container">
      ...
      <div className="container___">
        ...
        <p>
          ...
          experience purchasing from our webstore, SportsMall.com.
        </p>
        <p>
        ...
        <p>
          You (“Customer”) may place orders for Products with SportsMall
          ...
          agreed to or set forth in writing by SportsMall, any term or
        ...
        <h2>Orders</h2>
        <p>
          All orders are subject to SportsMall's acceptance. This means
          SportsMall may, for any reason, refuse to accept or may cancel or
          ...
          cancel an order after you have already been charged, SportsMall
        ...
        <p>
          ...
          and it is accepted by SportsMall. Prices for products displayed on
          ...
          website may differ from those in stores that stock SportsMall
          products, as these stores are independent of SportsMall.
          SportsMall reserves the right to amend pricing for any pricing
          ...
          submitted an online order, SportsMall will notify you of the error
        ...
        <p>
          ...
          SportsMall reserves the right to change or discontinue such offers
          at any time.
        </p>
        <h2>Taxes</h2>
        <p>
          The prices quoted for the products sold hereunder include applicable
          taxes. Customer shall pay, and reimburse SportsMall if it pays, any
          taxes, except for those based on SportsMall's income.
        </p>
        <h2>Payment</h2>
        <p>
        ...
        <p>
          ...
          process. Any timeframe provided by SportsMall for when the
          ...
          are beyond our control. SportsMall cannot be held liable for late
        ...
        <h2>Returns</h2>
        <p>
          Once an order has been placed and accepted by SportsMall, customer
          may not cancel such accepted order without SportsMall’s prior
          ...
          expenses. The product(s) must be returned to SportsMall within
        ...
        <p>
          ...
          indemnify and hold SportsMall harmless from and against any and all
        ...
        <p style={{ fontWeight: "500" }}>SportsMall</p>
        <p style={{ fontWeight: "500" }}>123 Main Street, City, Country</p>
        <p style={{ fontWeight: "500" }}>
          Email:{" "}
          <span style={{ fontWeight: "400" }}>info@SportsMall.com</span>
        </p>
      </div>
    </div>
  );
