...
const PaymentComponent = () => {
  ...
  console.log(shippingInfo,cartItems, "Shipping info cartitems")
    ...
    try {
      ...
      if (result.error) {
        ...
        if (result.paymentIntent.status === "succeeded") {
          ...
          // add new property inside newOrder object
  ...
  }, [dispatch, alert, error,history,order]);
