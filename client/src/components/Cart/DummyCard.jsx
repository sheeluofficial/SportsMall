...
const alert = useAlert();
  const handleValueCopy = (value,field) => {
    navigator.clipboard.writeText(value);
     alert.success(`${field} Copied`);
  };
        ...
        <DialogContent className={classes.dialogContent}>
          <div className={classes.creditCard}>
            ...
            <div
              ...
              onClick={() => handleValueCopy("CREDIT CARD", "Card Name")}
            >
              CREDIT CARD
            </div>
            <div
              className={classes.cardNumber}
              onClick={() => handleValueCopy("4242 4242 4242 4242", "Card Number")}
            >
              4242 4242 4242 4242
            </div>
            <div className={classes.cardDetails}>
              <div>
                ...
                <div
                  ...
                  onClick={() => handleValueCopy("12/23", "Expiry Date")}
                >
                  12/23
                </div>
              </div>
            ...
            <div
              className={classes.value}
              onClick={() => handleValueCopy("Robert Downey Jr", "User Name")}
            >
              Robert Downey Jr
            </div>
          </div>
